...
User.findById(id,function(err,user){
     ...
     passport.use(new LocalStrategy(function(username,password,done){
           User.findOne({'local.username' : username},function(err,user){
                ...
                if(user.local.email===user.google.email)
                {
                    return done(null,false,{message:'Please login using Google.'});
                }
                if(user.local.email===user.facebook.email)
                {
            ...
            if (!req.user) {
                ...
                User.findOne({ 'facebook.id' : profile.id }, function(err, user) {
                    ...
                    if (user) {
                        ...
                        newUser.local.username = newUser.local.name;
                ...
                user.local.username = user.local.name;
          ...
          if (!req.user) {
              ...
              User.findOne({ 'google.id' : profile.id }, function(err, user) {
                  ...
                  if (user) {
                      ...
                      newUser.local.username = profile.displayName.toLowerCase();
